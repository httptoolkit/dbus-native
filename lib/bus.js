...
module.exports = function bus(conn, opts) {
  ...
  this.invokeDbus = promisify(function(msg, callback) {
  ...
  function DBusService(name, bus) {
    ...
    this.getObject = promisify(function (name, callback) {
      ...
      introspect(obj, function (err, result) {
        if (err) return callback(err);
        const { interfaces, nodes } = result;
        obj.proxy = interfaces;
        obj.nodes = nodes;
        callback(null, obj);
      });
    });

    this.getInterface = promisify(function(objName, ifaceName, callback) {
  ...
  this.getObject = promisify(function(path, name, callback) {
    var service = this.getService(path);
    return service.getObject(name, callback);
  });

  this.getInterface = promisify(function(path, objname, name, callback) {
  ...
  // bus meta functions
  this.addMatch = promisify(function(match, callback) {
    this.invokeDbus(
  ...
  this.removeMatch = promisify(function(match, callback) {
    this.invokeDbus(
  ...
  this.getId = promisify(function(callback) {
    this.invokeDbus({ member: 'GetId' }, callback);
  });

  this.requestName = promisify(function(name, flags, callback) {
    this.invokeDbus(
  ...
  this.releaseName = promisify(function(name, callback) {
    this.invokeDbus(
  ...
  this.listNames = promisify(function(callback) {
    this.invokeDbus({ member: 'ListNames' }, callback);
  });

  this.listActivatableNames = promisify(function(callback) {
    this.invokeDbus({ member: 'ListActivatableNames' }, callback);
  });

  this.updateActivationEnvironment = promisify(function(env, callback) {
    this.invokeDbus(
      {
  ...
  this.startServiceByName = promisify(function(name, flags, callback) {
    this.invokeDbus(
  ...
  this.getConnectionUnixUser = promisify(function(name, callback) {
    this.invokeDbus(
  ...
  this.getConnectionUnixProcessId = promisify(function(name, callback) {
    this.invokeDbus(
  ...
  this.getNameOwner = promisify(function(name, callback) {
    this.invokeDbus(
  ...
  this.nameHasOwner = promisify(function(name, callback) {
    this.invokeDbus(
